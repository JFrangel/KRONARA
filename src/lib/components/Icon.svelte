<script>
  // Minimal inline icon set (Feather-style 24x24 stroke paths) -- no icon
  // package dependency, matching the project's minimal-runtime-deps stance.
  const PATHS = {
    grid: 'M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z',
    film: 'M3 3h18v18H3zM3 8h18M3 16h18M8 3v18M16 3v18',
    ...
    wand: 'M15 4V2M15 16v-2M8 9h2M20 9h2M17.8 6.2l1.4-1.4M6.2 17.8l1.4-1.4M17.8 11.8l1.4 1.4M6.2 6.2l1.4 1.4M3 21l9-9',
